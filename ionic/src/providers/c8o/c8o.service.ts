            ...
            //get the uri from env.json
                ...
                this.http.get(uri)
                    ...
                    .subscribe(data => {
                        ...
                        this._automaticRemoveSplashsCreen = data["splashScreenRemoveMode"] != "manual" ? true : false;
                        resolve();
                    });
            }
            //setup tests
            else{
                this.endpoint = "http://192.168.100.86:18080/convertigo";
                resolve();
            }
        }).then(() => {
